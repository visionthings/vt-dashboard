...
@Component({
  selector: 'app-open-visit-requests',
  standalone: true,
  imports: [
    LoadingComponent,
  ...
  templateUrl: './open-visit-requests.component.html',
  styleUrl: './open-visit-requests.component.scss',
})
export class OpenVisitRequestsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.dashboardService.openVisitRequests().subscribe({
      next: (res: any) => {
